...
quit: Quit the game.
How to Play
Download the Python script and place it in a directory on your computer.
...
The executable will be generated in the dist folder. You can access it and run the game without needing Python installed on the machine.
Contributions
